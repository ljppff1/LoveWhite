...
//布局内容
public class PersonDangEditActivity extends BaseActivity {
	...
	private ListView mLv1;
     private List<Data> list =new ArrayList<PersonDangEditActivity.Data>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.persondangedit);
         initView();
