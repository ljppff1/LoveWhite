...
//布局内容
public class PersonDangActivity extends BaseActivity {
	...
	private ListView mLv1;
     private List<Data> list =new ArrayList<PersonDangActivity.Data>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.persondang);
         initView();
		 ...
		 redSpan = new ForegroundColorSpan(Color.RED);  
			...
			mTvd1 =(TextView)this.findViewById(R.id.mTvd1);
			mTvd1.setOnClickListener(listener);
	}
	...
	private void initView() {
		...
		mLv1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				startActivity(new Intent(getApplicationContext(), PersonDangDetailActivity.class));
			}
		});
		 initData();
	...
	OnClickListener listener =new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.mRlw1:
				...
				break;
			case R.id.mTvd1:
				startActivity(new Intent(getApplicationContext(), PersonDangEditActivity.class));
				break;
